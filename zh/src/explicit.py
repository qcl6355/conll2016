...
class Explicit(object):
    ...
    def __init__(self):
        ...
        self.train_vec_file = FILE_PATH + '/../data/conll.exp.train.vec'
        self.feat_map_file = FILE_PATH + '/../data/conll.exp.feat.map'
        self.test_file = FILE_PATH + '/../data/conll.exp.test'
        self.test_vec_file = FILE_PATH + '/../data/conll.exp.test.vec'
