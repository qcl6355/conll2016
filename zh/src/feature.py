...
product_rule = FILE_PATH + '/../lib/zh-mi-product-rule.txt'
dep_rule = FILE_PATH + '/../lib/zh-mi-dep-rule.txt'
word_pair_path = FILE_PATH + '/../lib/zh-mi-word-pair.txt'
...
class Feature(object):
    ...
    def _load_production_rule(self, num=500):
    ...
    def _load_dependency_rule(self, num=500):
